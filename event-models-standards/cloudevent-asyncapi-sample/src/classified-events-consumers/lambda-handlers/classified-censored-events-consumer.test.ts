import { lambdaHandler } from "./classified-censored-events-consumer";

describe('Consume classified censored events lambda handler', () => {
    ...
    test('should not report failedItemsFailures when all events are valid', async () => {
        ...
        const events = [{
            ...
            data: {
                classifiedId: "456",
                censorshipReason: "some another reason"
            }
        }];
    ...
    test("should only report invalid events when the required event envelope attribute 'type' is missing", async () => {
        ...
        const events = [
            // event missing mandatory property type
            {
                id: "cabf382d-47d1-6666-8b82-fff00bad4acd",
                source: "abcd",
                eventcategory: 'IntegrationEvent',
        ...
        expect(res.batchItemFailures[0].itemIdentifier).toBe("cabf382d-47d1-6666-8b82-fff00bad4acd");
    ...
    test("should only report invalid events when the required proeprty on event data is missing", async () => {
        ...
        const events = [
            {
                id: "cabf382d-5555-4444-8b82-fff00bad4acd",
                type: "classified-censored.v1",
                source: "abcd",
                eventcategory: 'IntegrationEvent',
                specversion: "1.0",
                ...
                id: "cabf382d-1111-2222-8b82-fff00bad4bcd",
                type: "classified-censored.v1",
                source: "abcd",
                eventcategory: 'IntegrationEvent',
                specversion: "1.0",
        ...
        expect(res.batchItemFailures.length).toStrictEqual(1);
        expect(res.batchItemFailures[0].itemIdentifier).toBe("cabf382d-1111-2222-8b82-fff00bad4bcd");
