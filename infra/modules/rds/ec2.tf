...
sudo nohup socat TCP-LISTEN:${module.aurora_cluster.cluster_port},reuseaddr,fork TCP4:${module.aurora_cluster.cluster_endpoint}:${module.aurora_cluster.cluster_port} &
EOF
  root_block_device {
    volume_size           = "8"
    volume_type           = "gp2"
